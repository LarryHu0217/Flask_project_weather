...
# 2c7ecb5861c74f2ea3c01194905979bb
...
@app.route(
    '/result/<string:acc_key>/<string:query>/<string:observation_time>/<string:temperature>/<string:precipitation>/<string'
...
def current():
    if request.method == 'GET':
        ...
        return redirect(
            url_for('result_current', acc_key=acc_key, query=query, observation_time=observation_time,
